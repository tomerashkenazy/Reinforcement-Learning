...
if __name__ == "__main__":
    ...
    grid_search_df.to_csv("Assignment2/plots_A2_Q1/grid_search_results.csv", index=False)
    print("Grid search results saved to Assignment2/plots_A2_Q1/grid_search_results.csv")
